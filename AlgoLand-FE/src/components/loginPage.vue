    ...
    <div id="mainContainer">
        ...
        <div id="loginForm">
            <div class="loginInput">
                <h3 id="usernamePlaceHolder">Username or Email</h3>
                <input @input="placeHolderRemover('usernameInput', 'usernamePlaceHolder', 'Username or Email')" id="usernameInput">
            </div>
            <div class="loginInput">
                <h3 id="passwordPlaceHolder">Password</h3>
                <input type="password" @input="placeHolderRemover('passwordInput', 'passwordPlaceHolder', 'Password')" id="passwordInput">
            </div>
